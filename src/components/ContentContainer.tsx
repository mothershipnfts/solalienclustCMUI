    ...
    <div className="flex-1 drawer h-52 flex-col justify-between">
      ...
      <div className="drawer-side">
        ...
        <ul className="p-4 overflow-y-auto menu w-80 bg-base-100 gap-10 sm:flex items-center">
          <li>
            <Text variant="heading" className='font-extrabold tracking-tighter text-center text-transparent bg-clip-text bg-gradient-to-br from-green-400 to-green-600 mt-10'>Menu</Text>
          </li>
          <li>
          <NavElement
            label="Mint"
